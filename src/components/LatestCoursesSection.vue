<template>
  <div>
    <HeadingText :type="'blck'" :icon="upcomingIcon" :textAlign="left">
...
import CardElement from "./components_library/CardElement.vue";
import latestCoursesCards from "../data/latestCoursesCards";

export default {
  name: "LastestCoursesSection",
  components: {
    GridElement,
    ContainerElement,
    HeadingText,
